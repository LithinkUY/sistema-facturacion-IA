...
return [
    ...
    'payment_receipt_concept_hint' => 'Describe the product/service or reason for the payment (for example: Deposit for Project A).',
    ...
    'bank_reference_placeholder' => 'e.g. Deposit slip, transfer ID or check no.',
    'bank_reference_hint' => 'Add the bank deposit, transfer or cheque reference linked to this payment.',
    'payment_receipt_method_hint' => 'Select how the payment was received (cash, transfer, cheque, etc.).',
    ...
    'rut' => 'RUT / Tax ID',
    'rut_placeholder' => 'Enter customer RUT',
    ...
    // CFE - Electronic Fiscal Documents (DGI Uruguay)
    'cfe_status' => 'CFE Status',
    'cfe_pending' => 'Pending',
    'cfe_processing' => 'Processing',
    'cfe_accepted' => 'Accepted by DGI',
    'cfe_rejected' => 'Rejected by DGI',
    'cfe_error' => 'Error',
    'cfe_track_id' => 'CFE Track ID',
    'cfe_not_enabled' => 'CFE not enabled',
    'cfe_settings' => 'CFE Settings',
    'cfe_certificate' => 'Digital Certificate',
    'cfe_environment' => 'Environment',
    'cfe_environment_testing' => 'Testing',
    'cfe_environment_production' => 'Production',
    'cfe_auto_submit' => 'Auto-submit to DGI',
    'cfe_emitter_rut' => 'Emitter RUT',
    'cfe_download_xml' => 'Download CFE XML',
    'cfe_resend' => 'Resend to DGI',
];
