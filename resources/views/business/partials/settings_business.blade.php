<div class="pos-tab-content active">
    ...
    {{-- Facturación Electrónica Uruguay (DGI/BPS) --}}
    <div class="row">
        <div class="col-sm-12">
            <hr>
            <h4><i class="fas fa-file-invoice"></i> Facturación Electrónica Uruguay (DGI)</h4>
            <p class="text-muted">Configure el RUT de la empresa en la pestaña <strong>Impuestos</strong> (campo "Tax 1"), y los datos de ubicación (dirección, teléfono) en <strong>Ubicaciones del Negocio</strong>. Para la configuración completa de CFE (certificado digital, ambiente DGI, etc.) acceda a:</p>
            <a href="{{ url('/cfe/settings/index') }}" class="btn btn-primary btn-sm">
                <i class="fas fa-cog"></i> Configuración CFE / Facturación Electrónica
            </a>
            <a href="{{ url('/cfe') }}" class="btn btn-info btn-sm" style="margin-left: 5px;">
                <i class="fas fa-file-invoice"></i> Ver Comprobantes CFE
            </a>
        </div>
    </div>
</div>