				...
				<div class="col-sm-10 col-sm-offset-1">
					<div class="form-group">
						<div class="input-group">
							...
							<span class="input-group-btn">
								<button type="button" class="btn btn-default bg-white btn-flat" id="btn_manual_product" title="Agregar producto manual"><i class="fas fa-pencil-alt text-success fa-lg"></i></button>
							</span>
						</div>
					</div>
				</div>
...
<div class="modal fade" id="manual_product_modal" tabindex="-1" role="dialog" aria-labelledby="manualProductModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="manualProductModalLabel"><i class="fas fa-pencil-alt"></i> Agregar Producto Manual</h4>
      </div>
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" id="btn_save_manual_product"><i class="fas fa-save"></i> Guardar y agregar a la venta</button>
      </div>
    </div>
  </div>
</div>
    ...
    <script type="text/javascript">
    	$(document).ready( function() {
			...
			$('#btn_save_manual_product').click(function() {
				...
				if (!location_id) {
					toastr.warning('Seleccione una ubicación primero');
					return;
				}

				var btn = $(this);
				btn.attr('disabled', true).html('<i class="fas fa-spinner fa-spin"></i> Guardando...');
				...
				$.ajax({
					...
					success: function(data) {
						btn.attr('disabled', false).html('<i class="fas fa-save"></i> Guardar y agregar a la venta');
						if (data.success) {
			...
			$('#manual_product_modal').on('keypress', function(e) {
				if (e.which === 13) {
					e.preventDefault();
