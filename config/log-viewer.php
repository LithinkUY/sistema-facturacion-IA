...
// LogViewer package no está instalado, usar valores directamente
...
return [
    ...
    'pattern'       => [
        'prefix'    => 'laravel-',    // PATTERN_PREFIX
        'date'      => '[0-9][0-9][0-9][0-9]-[0-9][0-9]-[0-9][0-9]',      // PATTERN_DATE
        'extension' => '.log', // PATTERN_EXTENSION
    ],
